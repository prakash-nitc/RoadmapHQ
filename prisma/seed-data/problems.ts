...
export const problems: SeedProblem[] = [
  ...
  { title: "Maximum Subarray Sum with One Deletion", patternName: "Kadane's Algorithm", platform: "LEETCODE", url: "https://leetcode.com/problems/maximum-subarray-sum-with-one-deletion/" },
  ...
  // STACK
  // ═══════════════════════════════════════════════════════════════
  { title: "Remove Adjacent Duplicates", patternName: "Stack", platform: "LEETCODE", url: "https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/" },
  { title: "Balanced Parentheses", patternName: "Stack", platform: "LEETCODE", url: "https://leetcode.com/problems/valid-parentheses/" },
  { title: "Next Greater Element", patternName: "Stack", platform: "LEETCODE", url: "https://leetcode.com/problems/next-greater-element-ii/" },
  ...
  { title: "H-Index II", patternName: "Binary Search", platform: "LEETCODE", url: "https://leetcode.com/problems/h-index-ii/" },
  { title: "Max Candies to K Children", patternName: "Binary Search", platform: "LEETCODE", url: "https://leetcode.com/problems/maximum-candies-allocated-to-k-children/" },
  ...
  { title: "Kth Smallest in Sorted Matrix", patternName: "Binary Search", platform: "LEETCODE", url: "https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/" },
  ...
  { title: "Kth Largest Element in an Array", patternName: "Heap", subPattern: "Kth", platform: "LEETCODE", url: "https://leetcode.com/problems/kth-largest-element-in-an-array/" },
  { title: "Top K Frequent Elements", patternName: "Heap", subPattern: "Top K", platform: "LEETCODE", url: "https://leetcode.com/problems/top-k-frequent-elements/" },
  { title: "Top K Frequent Words", patternName: "Heap", subPattern: "Top K", platform: "LEETCODE", url: "https://leetcode.com/problems/top-k-frequent-words/" },
  { title: "K Closest Points to Origin", patternName: "Heap", subPattern: "K Closest", platform: "LEETCODE", url: "https://leetcode.com/problems/k-closest-points-to-origin/" },
  { title: "Find K Closest Elements", patternName: "Heap", subPattern: "K Closest", platform: "LEETCODE", url: "https://leetcode.com/problems/find-k-closest-elements/" },
  { title: "Kth Weakest Row in Matrix", patternName: "Heap", subPattern: "K Closest", platform: "LEETCODE", url: "https://leetcode.com/problems/the-k-weakest-rows-in-a-matrix/" },
  ...
  { title: "Kth Smallest in Sorted Matrix (Heap)", patternName: "Heap", subPattern: "Heap as Pointer", platform: "LEETCODE", url: "https://leetcode.com/problems/kth-smallest-element-in-a-sorted-matrix/" },
  { title: "Last Stone Weight", patternName: "Heap", subPattern: "Greedy + Heap", platform: "LEETCODE", url: "https://leetcode.com/problems/last-stone-weight/" },
  { title: "CPU Task Scheduler", patternName: "Heap", subPattern: "Greedy + Heap", platform: "LEETCODE", url: "https://leetcode.com/problems/task-scheduler/" },
  ...
  { title: "Minimum Number of Refueling Stops", patternName: "Heap", subPattern: "Greedy + Heap", platform: "LEETCODE", url: "https://leetcode.com/problems/minimum-number-of-refueling-stops/" },
  { title: "IPO", patternName: "Heap", subPattern: "Greedy + Heap", platform: "LEETCODE", url: "https://leetcode.com/problems/ipo/" },
  { title: "Course Schedule III", patternName: "Heap", subPattern: "Greedy + Heap", platform: "LEETCODE", url: "https://leetcode.com/problems/course-schedule-iii/" },
  ...
  // TREES
  // ═══════════════════════════════════════════════════════════════
  { title: "Binary Tree Inorder Traversal", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-inorder-traversal/" },
  { title: "Binary Tree Preorder Traversal", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-preorder-traversal/" },
  { title: "Binary Tree Postorder Traversal", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-postorder-traversal/", isHomework: true },
  { title: "Binary Tree Level Order Traversal", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-level-order-traversal/" },
  { title: "Binary Tree Zigzag Level Order Traversal", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/" },
  { title: "Binary Tree Level Order Traversal II", patternName: "Trees", subPattern: "Traversal", platform: "LEETCODE", url: "https://leetcode.com/problems/binary-tree-level-order-traversal-ii/", isHomework: true },
  { title: "Invert Binary Tree", patternName: "Trees", subPattern: "Mirror & Symmetry", platform: "LEETCODE", url: "https://leetcode.com/problems/invert-binary-tree/" },
  { title: "Symmetric Tree", patternName: "Trees", subPattern: "Mirror & Symmetry", platform: "LEETCODE", url: "https://leetcode.com/problems/symmetric-tree/" },
  { title: "Same Tree", patternName: "Trees", subPattern: "Mirror & Symmetry", platform: "LEETCODE", url: "https://leetcode.com/problems/same-tree/", isHomework: true },
  { title: "Subtree of Another Tree", patternName: "Trees", subPattern: "Mirror & Symmetry", platform: "LEETCODE", url: "https://leetcode.com/problems/subtree-of-another-tree/" },
  { title: "Flip Equivalent Binary Trees", patternName: "Trees", subPattern: "Mirror & Symmetry", platform: "LEETCODE", url: "https://leetcode.com/problems/flip-equivalent-binary-trees/" },
  { title: "LCA of Binary Tree", patternName: "Trees", subPattern: "Search", platform: "LEETCODE", url: "https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-tree/" },
  ...
  { title: "LCA of BST", patternName: "Trees", subPattern: "Search", platform: "LEETCODE", url: "https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/" },
  { title: "LCA of Deepest Leaves", patternName: "Trees", subPattern: "Search", platform: "LEETCODE", url: "https://leetcode.com/problems/lowest-common-ancestor-of-deepest-leaves/" },
  { title: "Two Sum IV - BST", patternName: "Trees", subPattern: "Search", platform: "LEETCODE", url: "https://leetcode.com/problems/two-sum-iv-input-is-a-bst/" },
  { title: "Kth Smallest Element in a BST", patternName: "Trees", subPattern: "Search", platform: "LEETCODE", url: "https://leetcode.com/problems/kth-smallest-element-in-a-bst/" },
  { title: "Minimum Depth of Binary Tree", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/minimum-depth-of-binary-tree/" },
  { title: "Maximum Depth of Binary Tree", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/maximum-depth-of-binary-tree/" },
  { title: "Balanced Binary Tree", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/balanced-binary-tree/" },
  { title: "Diameter of Binary Tree", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/diameter-of-binary-tree/" },
  { title: "Check Completeness of Binary Tree", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/check-completeness-of-a-binary-tree/" },
  { title: "Validate BST", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/validate-binary-search-tree/" },
  { title: "Recover BST", patternName: "Trees", subPattern: "Validation", platform: "LEETCODE", url: "https://leetcode.com/problems/recover-binary-search-tree/" },
  { title: "Path Sum", patternName: "Trees", subPattern: "Path Sum", platform: "LEETCODE", url: "https://leetcode.com/problems/path-sum/" },
  { title: "Path Sum II", patternName: "Trees", subPattern: "Path Sum", platform: "LEETCODE", url: "https://leetcode.com/problems/path-sum-ii/" },
  { title: "Sum Root to Leaf Numbers", patternName: "Trees", subPattern: "Path Sum", platform: "LEETCODE", url: "https://leetcode.com/problems/sum-root-to-leaf-numbers/" },
